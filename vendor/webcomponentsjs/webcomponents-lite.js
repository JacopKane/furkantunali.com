...
!(function() {
        ...
        switch (d) {
          ...
          case 'port':
            if (/[0-9]/.test(b)) u += b
              ...
              '\t' == b || '\n' == b || '\r' == b
                ? c('Invalid code point in port: ' + b)
                : n.call(this)
            }
            break
          case 'relative path start':
            if (
              ('\\' == b && c("'\\' not allowed in path."),
              (d = 'relative path'),
              '/' != b && '\\' != b)
            )
              continue
    ...
    if (!e.JsMutationObserver) {
      ...
      a.prototype = {
        observe: function(e, t) {
          ...
          r || ((r = new p(this, e, t)), o.push(r), this.nodes_.push(e)),
            r.addListeners()
        },
        disconnect: function() {
            ...
            case 'DOMAttrModified':
              ...
              i(o, function(e) {
                if (
                  ...
                  return e.attributeOldValue ? l(a) : r
              })
              break
    ...
    if (n) {
      ...
      d.insertBefore(c, d.firstElementChild),
            ...
            if (
              ...
              try {
                Object.defineProperty(e, 'innerHTML', {
                  get: function() {
                    for (
                      var e = '', n = this.content.firstChild;
                      n;
                      n = n.nextSibling
                    )
                  ...
                  set: function(e) {
                    for (
                      a.body.innerHTML = e, i.bootstrap(a);
        ...
        (i.bootstrap = function(e) {
          for (
            var t, n = e.querySelectorAll(r), o = 0, a = n.length;
            o < a && (t = n[o]);
            o++
          )
            i.decorate(t)
    ...
    if (n || o) {
      ...
      ;(i.cloneNode = function(e, t) {
        ...
        return (
          ...
          t &&
            (n.content.appendChild(h.call(e.content, !0)),
            this.fixClonedDom(n.content, e.content)),
          n
        )
      }),
        (i.fixClonedDom = function(e, t) {
          if (t.querySelectorAll)
            for (
              ...
              (o = i[s]),
                (n = a[s]),
                this.decorate && this.decorate(o),
                n.parentNode.replaceChild(o.cloneNode(!0), n)
        })
  ...
  (function(e) {
      ...
      if (n(t)) e && e()
        ...
        var r = function() {
          ;('complete' !== t.readyState && t.readyState !== w) ||
            (t.removeEventListener(_, r), o(e, t))
        }
    ...
    function i(e, t) {
      ...
      var s = t.querySelectorAll('link[rel=import]'),
        ...
        u = []
      if (d)
        for (var h, f = 0; f < d && (h = s[f]); f++)
          a(h)
            ? (l.push(this), c++, n())
            : (h.addEventListener('load', o), h.addEventListener('error', i))
      else n()
    }
    function a(e) {
      return u
    ...
    Object.defineProperty(document, '_currentScript', m),
      Object.defineProperty(p, '_currentScript', m)
      ...
      o = {
        resolveUrlsInStyle: function(e, t) {
          var n = e.ownerDocument,
            o = n.createElement('a')
          return (
            (e.textContent = this.resolveUrlsInCssText(e.textContent, t, o)), e
          )
        },
      ...
      h = {
        ...
        nextToParseInDoc: function(e, n) {
          if (e && this._mayParse.indexOf(e) < 0) {
            ...
            for (
              var o,
                r = e.querySelectorAll(this.parseSelectorsForNode(e)),
                i = 0,
                a = r.length;
              i < a && (o = r[i]);
              i++
              ...
              if (!this.isParsed(o))
                return this.hasResource(o)
                  ? t(o)
                    ? this.nextToParseInDoc(o.__doc, o)
                    : o
                  : void 0
          }
          return n
  ...
  window.HTMLImports.addModule(function(e) {
    ...
    function r(e, t) {
      ...
      r.setAttribute('href', t),
        n.baseURI || o(n) || Object.defineProperty(n, 'baseURI', { value: t })
    ...
    if (((h.observer = new l()), !document.baseURI)) {
      ...
      Object.defineProperty(document, 'baseURI', p),
        Object.defineProperty(c, 'baseURI', p)
    }
  ...
  window.CustomElements.addModule(function(e) {
    ...
    function v(e) {
      ;(e = window.wrap(e)),
        _.dom && console.group('upgradeDocument: ', e.baseURI.split('/').pop())
  ...
  window.CustomElements.addModule(function(e) {
    ...
    function f(e, t) {
      ...
      var o
      return t
        ? ((o = f(e)), o.setAttribute('is', t), o)
        : ((o = N(e)), e.indexOf('-') >= 0 && g(o, HTMLElement), o)
    }
    function p(e, t) {
      var n = e[t]
      e[t] = function() {
