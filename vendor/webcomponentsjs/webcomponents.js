...
!(function() {
  ...
  ;(n.shadow = n.shadow || n.shadowdom || n.polyfill),
    'native' === n.shadow
      ? (n.shadow = !1)
      : (n.shadow = n.shadow || !HTMLElement.prototype.createShadowRoot),
    n.register &&
      ((window.CustomElements = window.CustomElements || { flags: {} }),
      (window.CustomElements.flags.register = n.register)),
    (WebComponents.flags = n)
})(),
  WebComponents.flags.shadow &&
    ...
    (function(e) {
      ...
      function w(t, n, r, o) {
        for (var i = W(t), a = 0; a < i.length; a++) {
          var s = i[a]
          if (
            'polymerBlackList_' !== s &&
            ...
            if ('function' != typeof d.value) {
              var w = u(s)
              ;(c = w ? e.getEventHandlerGetter(s) : p(s)),
                (d.writable || d.set || V) &&
                  (l = w ? e.getEventHandlerSetter(s) : h(s))
      ...
      function M(e) {
        return null === e ? null : (n(_(e)), e.__impl4cf1e782hg__)
      }
      function O(e) {
      ...
      function j(e, t) {
        null !== t &&
          (n(S(e)), n(void 0 === t || _(t)), (e.__wrapper8e3dd93a60__ = t))
      }
      function D(e, t, n) {
      ...
      var R = new WeakMap(),
        ...
        U = { value: void 0, configurable: !0, enumerable: !1, writable: !0 }
      W(window)
      ...
      ;(e.addForwardingProperties = c),
        ...
        (e.isIdentifierName = d),
        (e.isWrapper = _),
        (e.isWrapperFor = b),
        (e.mixin = r),
        (e.nativePrototypeTable = I),
        (e.oneOf = i),
        (e.registerObject = y),
        (e.registerWrapper = v),
        (e.rewrap = j),
      ...
      ;(n.prototype = {
            ...
            if (0 != t)
              if (0 != n) {
                var l,
                  ...
                  d = e[t - 1][n],
                  p = e[t][n - 1]
                ;(l = d < p ? (d < u ? d : u) : p < u ? p : u),
                  l == u
                    ? (u == s ? c.push(r) : (c.push(o), (s = u)), t--, n--)
                    : l == d
                    ? (c.push(a), t--, (s = d))
                    : (c.push(i), n--, (s = p))
              } else c.push(a), t--
        ...
        calcSplices: function(e, n, s, c, l, u) {
          var d = 0,
            ...
            h = Math.min(s - n, u - l)
          if (
            (0 == n && 0 == l && (d = this.sharedPrefix(e, c, h)),
            s == e.length &&
              u == c.length &&
              (p = this.sharedSuffix(e, c, h - d)),
            (n += d),
            (l += d),
            (s -= p),
            (u -= p),
            ...
            return []
          if (n == s) {
            for (var f = t(n, [], 0); l < u; ) f.removed.push(c[l++])
            return [f]
          }
          if (l == u) return [t(n, [], s - n)]
          for (
            var m = this.spliceOperationsFromEditDistances(
                this.calcEditDistances(e, n, s, c, l, u)
              ),
              f = void 0,
              w = [],
              v = n,
            ...
            switch (m[b]) {
              ...
              case i:
                ...
                break
              case a:
                f || (f = t(v, [], 0)), f.removed.push(c[g]), g++
            }
          return f && w.push(f), w
        },
    ...
    (function(e) {
      'use strict'
      function t(e) {
        e.scheduled_ || ((e.scheduled_ = !0), f.push(e), m || (u(n), (m = !0)))
      }
      function n() {
        for (m = !1; f.length; ) {
          var e = f
      ...
      function r(e, t) {
        ;(this.type = e),
          (this.target = t),
          (this.addedNodes = new p.NodeList()),
          (this.removedNodes = new p.NodeList()),
      ...
      function a(e, n, o) {
            ...
            for (var l = 0; l < c.length; l++) {
              ...
              if (
                ...
                ('attributes' !== n ||
                  !d.attributeFilter ||
                  (null === o.namespace &&
                    d.attributeFilter.indexOf(o.name) !== -1)) &&
                ('characterData' !== n || d.characterData) &&
                ('childList' !== n || d.childList)
              ) {
                var p = u.observer
                ;(i[p.uid_] = p),
                  (('attributes' === n && d.attributeOldValue) ||
                    ('characterData' === n && d.characterDataOldValue)) &&
                    (a[p.uid_] = o.oldValue)
              }
            }
        }
        for (var f in i) {
          ...
          'name' in o &&
            'namespace' in o &&
            ((m.attributeName = o.name), (m.attributeNamespace = o.namespace)),
            o.addedNodes && (m.addedNodes = o.addedNodes),
            o.removedNodes && (m.removedNodes = o.removedNodes),
            o.previousSibling && (m.previousSibling = o.previousSibling),
            o.nextSibling && (m.nextSibling = o.nextSibling),
            void 0 !== a[f] && (m.oldValue = a[f]),
            t(p),
            p.records_.push(m)
        }
      }
      function s(e) {
        if (
          ...
          (!this.attributes &&
            (e.attributeOldValue || 'attributeFilter' in e)) ||
    ...
    (function(e) {
      ...
      function s(e, t) {
        ...
        for (
          var n = A(t), r = e[0], o = A(r), i = l(n, o), a = 0;
          a < e.length;
          a++
        ) {
          var s = e[a]
      ...
      function p(e) {
        if (!K.get(e) && (K.set(e, !0), f(V(e), V(e.target)), P)) {
          var t = P
          throw ((P = null), t)
        }
      }
      ...
      function f(t, n) {
        if ($.get(t)) throw new Error('InvalidStateError')
        $.set(t, !0), e.renderAllPending()
        var o, i, a
        if (h(t) && !t.bubbles) {
          var s = n
      ...
      function y(e, t) {
        ...
        var n = e
        return be || 'beforeunload' !== n.type || this instanceof M
          ? void U(n, this)
          : new M(n)
      }
      function E(e) {
        return e && e.relatedTarget
          ? Object.create(e, { relatedTarget: { value: B(e.relatedTarget) } })
          : e
      }
      function _(e, t, n) {
        var r = window[e],
          o = function(t, n) {
            return t instanceof r ? void U(t, this) : V(T(r, e, t, n))
          }
        if (
      ...
      function T(e, t, n, r) {
        ...
        var o = B(document.createEvent(t)),
          i = we[t],
          a = [n]
        return (
          Object.keys(i).forEach(function(e) {
            var t = null != r && e in r ? r[e] : i[e]
            'relatedTarget' === e && (t = B(t)), a.push(t)
          }),
          o['init' + t].apply(o, a),
          o
        )
      ...
      function C(e) {
        return e instanceof G.ShadowRoot && (e = e.host), B(e)
      }
      function j(e, t) {
        var n = z.get(e)
        if (n)
      ...
      function D(e, t) {
        for (var n = B(e); n; n = n.parentNode) if (j(V(n), t)) return !0
        return !1
      }
      function H(e) {
        k(e, Ee)
      ...
      function x(t, n, o, i) {
        e.renderAllPending()
        var a = V(_e.call(q(n), o, i))
        if (!a) return null
        var c = r(a, null),
          l = c.lastIndexOf(t)
        return l == -1 ? null : ((c = c.slice(0, l)), s(c, t))
      }
      function R(e) {
        return function() {
          var t = te.get(this)
      ...
      var le = _('UIEvent', y),
        ...
        de = {
          get relatedTarget() {
            var e = Z.get(this)
            return void 0 !== e ? e : V(B(this).relatedTarget)
          }
        },
        pe = W({ initMouseEvent: S('initMouseEvent', 14) }, de),
        he = W({ initFocusEvent: S('initFocusEvent', 5) }, de),
        fe = _('MouseEvent', le, pe),
        me = _('FocusEvent', le, he),
      ...
      ;[Node, Window].forEach(function(e) {
        ...
        (N.prototype = {
          ...
          dispatchEvent: function(t) {
            ...
            var o
            D(this, r) || ((o = function() {}), this.addEventListener(r, o, !0))
            try {
      ...
      ;(e.elementFromPoint = x),
        ...
        (e.getEventHandlerSetter = I),
        (e.wrapEventTargetMethods = H),
        (e.wrappers.BeforeUnloadEvent = M),
        (e.wrappers.CustomEvent = ue),
        (e.wrappers.Event = y),
        (e.wrappers.EventTarget = N),
        (e.wrappers.FocusEvent = me),
        (e.wrappers.MouseEvent = fe),
        (e.wrappers.UIEvent = le)
    })(window.ShadowDOMPolyfill),
    (function(e) {
      'use strict'
      function t(e, t) {
    ...
    (function(e) {
      ...
      function h(e, t) {
        var n = e.nodeType === _.DOCUMENT_NODE ? e : e.ownerDocument
      ...
      function m(e, t) {
        ...
        if (1 === n) return P(t[0])
        for (
          var r = P(e.ownerDocument.createDocumentFragment()), o = 0;
          o < n;
          o++
        )
          r.appendChild(P(t[o]))
      ...
      function y(e, t, n) {
        var r
        if (((r = A(n ? q.call(n, I(e), !1) : B.call(I(e), !1))), t)) {
      ...
      var S = e.wrappers.EventTarget,
        T = e.wrappers.NodeList,
        M = e.TreeScope,
        O = e.assert,
        L = e.defineWrapGetter,
        N = e.enqueueMutation,
        C = e.getTreeScope,
        j = e.isWrapper,
        D = e.mixin,
      ...
      ;(_.prototype = Object.create(S.prototype)),
        D(_.prototype, {
          ...
          replaceChild: function(e, r) {
            ...
            var o
            if (
              (j(r) ? (o = P(r)) : ((o = r), (r = A(o))), r.parentNode !== this)
            )
              throw new Error('NotFoundError')
            var s,
              c = r.nextSibling,
              l = r.previousSibling,
              p = !this.invalidateShadowRenderer() && !g(e)
            return (
              p
                ? (s = a(e))
                : (c === e && (c = e.nextSibling), (s = i(e, this, l, c))),
              p
                ? (h(this, e), w(this), Y.call(I(this), P(e), o))
                : (this.firstChild === r && (this.firstChild_ = s[0]),
                  ...
                  o.parentNode && Y.call(o.parentNode, m(this, s), o)),
              N(this, 'childList', {
                addedNodes: s,
                removedNodes: n(r),
                nextSibling: c,
          ...
          get nextSibling() {
            return void 0 !== this.nextSibling_
              ? this.nextSibling_
              : A(I(this).nextSibling)
          },
          get previousSibling() {
            return void 0 !== this.previousSibling_
              ? this.previousSibling_
              : A(I(this).previousSibling)
          },
          get parentElement() {
            for (var e = this.parentNode; e && e.nodeType !== _.ELEMENT_NODE; )
              e = e.parentNode
            return e
          },
          get textContent() {
            for (var e = '', t = this.firstChild; t; t = t.nextSibling)
              t.nodeType != _.COMMENT_NODE && (e += t.textContent)
            return e
          },
          set textContent(e) {
            null == e && (e = '')
            ...
            } else w(this), (I(this).textContent = e)
            var r = c(this.childNodes)
            N(this, 'childList', { addedNodes: r, removedNodes: t }),
              p(t),
              u(r, this)
          },
          get childNodes() {
          ...
          compareDocumentPosition: function(e) {
            return z.call(I(this), k(e))
          },
          isEqualNode: function(e) {
            return K.call(I(this), k(e))
          },
          normalize: function() {
            for (
        ...
        L(_, 'ownerDocument'),
        x(V, _, document.createDocumentFragment()),
        delete _.prototype.querySelector,
        delete _.prototype.querySelectorAll,
        (_.prototype = D(Object.create(S.prototype), _.prototype)),
        (e.cloneNode = y),
        (e.nodeWasAdded = l),
        (e.nodeWasRemoved = d),
        (e.nodesWereAdded = u),
        (e.nodesWereRemoved = p),
        (e.originalInsertBefore = $),
        (e.originalRemoveChild = X),
    ...
    (function(e) {
      ...
      function a(e, t, n) {
        var r = e.localName
        return r === t || (r === n && e.namespaceURI === j)
      }
      function s() {
        return !0
      }
      ...
      function p(n, r, o, i, a) {
        var s,
          c = g(this),
          l = v(this).root
        if (l instanceof e.wrappers.ShadowRoot) return d(this, r, o, n, i, null)
        if (c instanceof N) s = S.call(c, i)
        else {
          if (!(c instanceof C)) return d(this, r, o, n, i, null)
          s = _.call(c, i)
        }
        return t(s, r, o, a)
      }
      function h(n, r, o, i, a) {
        var s,
          c = g(this),
          l = v(this).root
        if (l instanceof e.wrappers.ShadowRoot) return d(this, r, o, n, i, a)
        if (c instanceof N) s = M.call(c, i, a)
        else {
          if (!(c instanceof C)) return d(this, r, o, n, i, a)
          s = T.call(c, i, a)
        }
        return t(s, r, o, !1)
      }
      function f(n, r, o, i, a) {
        var s,
          ...
          l = v(this).root
        if (l instanceof e.wrappers.ShadowRoot) return d(this, r, o, n, i, a)
        if (c instanceof N) s = L.call(c, i, a)
        else {
          if (!(c instanceof C)) return d(this, r, o, n, i, a)
          s = O.call(c, i, a)
        }
      ...
      var m = e.wrappers.HTMLCollection,
        w = e.wrappers.NodeList,
        v = e.getTreeScope,
        g = e.unsafeUnwrap,
        b = e.wrap,
        ...
        S = document.documentElement.querySelectorAll,
        T = document.getElementsByTagName,
        M = document.documentElement.getElementsByTagName,
        O = document.getElementsByTagNameNS,
        L = document.documentElement.getElementsByTagNameNS,
        N = window.Element,
        ...
        D = {
          querySelector: function(t) {
            ...
            if (s instanceof N) a = b(E.call(s, t))
            else {
              if (!(s instanceof C)) return o(this, t)
              a = b(y.call(s, t))
            }
            return a &&
              !i &&
          ...
          querySelectorAll: function(e) {
            ...
            e = t
            var o = new w()
            return (o.length = p.call(this, i, 0, o, e, r)), o
          }
        },
        H = {
          matches: function(t) {
        ...
        x = {
          getElementsByTagName: function(e) {
            var t = new m(),
              n = '*' === e ? s : a
            return (t.length = h.call(this, n, 0, t, e, e.toLowerCase())), t
          },
          ...
          getElementsByTagNameNS: function(e, t) {
            ...
            return (
              (r = '*' === e ? ('*' === t ? s : c) : '*' === t ? l : u),
              (n.length = f.call(this, r, 0, n, e || null, t)),
              n
            )
          }
        }
      ;(e.GetElementsByInterface = x),
        (e.SelectorsInterface = D),
    ...
    (function(e) {
      ...
      function n(e, t, n) {
        u(e, 'attributes', { name: t, namespace: null, oldValue: n })
      }
      function r(e) {
        a.call(this, e)
      }
      var o = e.ChildNodeInterface,
        ...
        l = e.MatchesInterface,
        u = (e.addWrapNodeListMethod, e.enqueueMutation),
        d = e.mixin,
        p = (e.oneOf, e.registerWrapper),
        h = e.unsafeUnwrap,
        f = e.wrappers,
        m = window.Element,
        w = [
      ...
      ;(r.prototype = Object.create(a.prototype)),
        d(r.prototype, {
          createShadowRoot: function() {
            ...
            h(this).polymerShadowRoot_ = t
            var n = e.getRendererForHost(this)
            return n.invalidate(), t
          },
          get shadowRoot() {
            return h(this).polymerShadowRoot_ || null
          },
          setAttribute: function(e, r) {
            var o = h(this).getAttribute(e)
            h(this).setAttribute(e, r), n(this, e, o), t(this, e)
          },
          removeAttribute: function(e) {
            var r = h(this).getAttribute(e)
            h(this).removeAttribute(e), n(this, e, r), t(this, e)
          },
          get classList() {
            var e = b.get(this)
            if (!e) {
              if (((e = h(this).classList), !e)) return
              ;(e.ownerElement_ = this), b.set(this, e)
            }
            return e
          },
          get className() {
            return h(this).className
          },
          set className(e) {
        ...
        m.prototype.webkitCreateShadowRoot &&
        ...
        d(r.prototype, c),
        d(r.prototype, l),
        p(m, r, document.createElementNS(null, 'x')),
    ...
    (function(e) {
      ...
      function s(e) {
        e instanceof O.HTMLTemplateElement && (e = e.content)
      ...
      ;(l.prototype = Object.create(m.prototype)),
        g(l.prototype, {
          ...
          set innerHTML(e) {
            if (H && j[this.localName]) return void (this.textContent = e)
            var t = _(this.childNodes)
            this.invalidateShadowRenderer()
              ? this instanceof O.HTMLTemplateElement
                ? c(this.content, e)
                : c(this, e, this.tagName)
              : !R && this instanceof O.HTMLTemplateElement
              ? c(this.content, e)
              : (S(this).innerHTML = e)
            var n = _(this.childNodes)
        ...
        ['scrollLeft', 'scrollTop'].forEach(h),
        [
          'focus',
        ...
        E(x, l, document.createElement('b')),
        (e.wrappers.HTMLElement = l),
        (e.getInnerHTML = s),
        (e.setInnerHTML = c)
    })(window.ShadowDOMPolyfill),
    (function(e) {
    ...
    (function(e) {
      ...
      ;(n.prototype = Object.create(o.prototype)),
        ...
        a(u, n, document.createElement('option')),
    ...
    (function(e) {
      ...
      var n = e.wrappers.Element,
        ...
        l = window.SVGElement,
        u = document.createElementNS(c, 'title')
      if (!('classList' in u)) {
        var d = Object.getOwnPropertyDescriptor(n.prototype, 'classList')
        Object.defineProperty(r.prototype, 'classList', d),
      ...
      ;(t.prototype = Object.create(n.prototype)),
        ...
        o(l, t, document.createElementNS(c, 'title')),
    ...
    (function(e) {
      ...
      var n = e.mixin,
        ...
        l = document.createElementNS(s, 'use'),
        u = c.constructor,
        d = Object.getPrototypeOf(u.prototype),
        p = d.constructor
    ...
    (function(e) {
      ...
      var n = e.mixin,
        ...
        s = e.unwrapIfNeeded,
        c = e.wrap,
        l = window.CanvasRenderingContext2D
      n(t.prototype, {
        get canvas() {
        ...
        r(l, t, document.createElement('canvas').getContext('2d')),
    ...
    (function(e) {
      ...
      var n = e.addForwardingProperties,
        ...
        s = e.unwrapIfNeeded,
        c = e.wrap,
        l = window.WebGLRenderingContext
      if (l) {
        r(t.prototype, {
          get canvas() {
        ...
        var d = /WebKit/.test(navigator.userAgent)
    ...
    (function(e) {
      ...
      var n = e.wrappers.Node,
        ...
        c = e.registerObject,
        l = e.registerWrapper,
        u = window.DocumentFragment
      ;(t.prototype = Object.create(n.prototype)),
        s(t.prototype, i),
        s(t.prototype, a),
        s(t.prototype, r),
        s(t.prototype, o),
        l(u, t, document.createDocumentFragment()),
      ...
      ;(t.prototype = Object.create(n.prototype)),
        s(t.prototype, {
          ...
          invalidateShadowRenderer: function() {
            return h.get(this).invalidateShadowRenderer()
          },
          ...
          get activeElement() {
            var e = d(this).ownerDocument.activeElement
            if (!e || !e.nodeType) return null
            for (var t = p(e); !this.contains(t); ) {
    ...
    (function(e) {
      ...
      function t(e) {
        var t = d(e).root
        return t instanceof h ? t.host : null
      }
      function n(t, n) {
        if (t.shadowRoot) {
      ...
      ;(o.prototype = {
        ...
        setStart: function(e, t) {
          ;(e = n(e, t)), s(this).setStart(l(e), t)
        },
        setEnd: function(e, t) {
          ;(e = n(e, t)), s(this).setEnd(l(e), t)
        },
        setStartBefore: function(e) {
          s(this).setStartBefore(l(e))
        },
        setStartAfter: function(e) {
          s(this).setStartAfter(l(e))
        },
        setEndBefore: function(e) {
          s(this).setEndBefore(l(e))
        },
        setEndAfter: function(e) {
          s(this).setEndAfter(l(e))
        },
        selectNode: function(e) {
          s(this).selectNode(l(e))
        },
        selectNodeContents: function(e) {
          s(this).selectNodeContents(l(e))
        },
        compareBoundaryPoints: function(e, t) {
          return s(this).compareBoundaryPoints(e, c(t))
        },
        extractContents: function() {
          return u(s(this).extractContents())
        },
        cloneContents: function() {
          return u(s(this).cloneContents())
        },
        insertNode: function(e) {
          s(this).insertNode(l(e))
        },
        surroundContents: function(e) {
          s(this).surroundContents(l(e))
        },
        cloneRange: function() {
          return u(s(this).cloneRange())
        },
        isPointInRange: function(e, t) {
          return s(this).isPointInRange(l(e), t)
        },
        comparePoint: function(e, t) {
          return s(this).comparePoint(l(e), t)
        },
        intersectsNode: function(e) {
          return s(this).intersectsNode(l(e))
        },
        toString: function() {
          return s(this).toString()
        }
      }),
        p.prototype.createContextualFragment &&
          (o.prototype.createContextualFragment = function(e) {
            return u(s(this).createContextualFragment(e))
          }),
    ...
    (function(e) {
      ...
      function l(e) {
        var t = A.get(e)
        return t || ((t = new h(e)), A.set(e, t)), t
      }
      function u(e) {
        var t = j(e).root
      ...
      var T,
        M = e.wrappers.Element,
        O = e.wrappers.HTMLContentElement,
        L = e.wrappers.HTMLShadowElement,
        N = e.wrappers.Node,
        C = e.wrappers.ShadowRoot,
        j = (e.assert, e.getTreeScope),
        D = (e.mixin, e.oneOf),
        H = e.unsafeUnwrap,
        x = e.unwrap,
        R = e.wrap,
          ...
          sync: function(e) {
            if (!this.skip) {
              for (
                ...
                for (var h = c[p]; d < h.index; d++) u++, o[l++].sync(s)
                for (var f = h.removed.length, m = 0; m < f; m++) {
                  var w = R(i[u++])
                  s.get(w) || r(w)
                }
                for (
                  var v = h.addedCount, g = i[u] && R(i[u]), m = 0;
                  m < v;
                  m++
                ) {
                  var b = o[l++],
      ...
      var q = /^(:not\()?[*.#[a-zA-Z_|]/
      ;(N.prototype.invalidateShadowRenderer = function(e) {
        var t = H(this).polymerShadowRenderer_
        return !!t && (t.invalidate(), !0)
      }),
        (O.prototype.getDistributedNodes = L.prototype.getDistributedNodes = function() {
          return s(), i(this)
        }),
        (M.prototype.getDestinationInsertionPoints = function() {
          return s(), v(this) || []
        }),
        (O.prototype.nodeIsInserted_ = L.prototype.nodeIsInserted_ = function() {
          this.invalidateShadowRenderer()
          var e,
            t = u(this)
          t && (e = d(t)),
    ...
    (function(e) {
      'use strict'
      function t(e) {
        u.call(this, e), (this.treeScope_ = new w(this, null))
      }
      function n(e) {
        var n = document[e]
        t.prototype[e] = function() {
          return j(n.apply(N(this), arguments))
        }
      }
      function r(e, t) {
        x.call(N(t), C(e)), o(e, t)
      }
      function o(e, t) {
        e.shadowRoot && t.adoptNode(e.shadowRoot), e instanceof m && i(e, t)
      ...
      function c(e, t) {
        var n = document.implementation[t]
        e.prototype[t] = function() {
          return n.apply(N(this), arguments)
        }
      }
      var l = e.GetElementsByInterface,
        u = e.wrappers.Node,
        d = e.ParentNodeInterface,
        p = e.NonElementParentNodeInterface,
        h = e.wrappers.Selection,
        f = e.SelectorsInterface,
        m = e.wrappers.ShadowRoot,
        w = e.TreeScope,
        v = e.cloneNode,
        g = e.defineGetter,
        ...
        S = e.mixin,
        T = e.registerWrapper,
        M = e.renderAllPending,
        O = e.rewrap,
        L = e.setWrapper,
        N = e.unsafeUnwrap,
        C = e.unwrap,
        j = e.wrap,
        D = e.wrapEventTargetMethods,
      ...
      ;(t.prototype = Object.create(u.prototype)),
        ...
        g(t, 'activeElement', function() {
          var e = C(this).activeElement
          if (!e || !e.nodeType) return null
          for (var t = j(e); !this.contains(t); ) {
            for (; t.parentNode; ) t = t.parentNode
            if (!t.host) return null
            t = t.host
          }
      ...
      S(t.prototype, {
        ...
        getSelection: function() {
          return M(), new h(R.call(C(this)))
        },
        getElementsByName: function(e) {
          return f.querySelectorAll.call(
            this,
      ...
      if (
        ...
        ;(t.prototype.registerElement = function(t, n) {
          ...
          for (var l = Object.create(a), u = c.length - 1; u >= 0; u--)
            l = Object.create(l)
          ;[
            'createdCallback',
            'attachedCallback',
            ...
            t &&
              (l[e] = function() {
                j(this) instanceof r || O(this), t.apply(j(this), arguments)
              })
          })
          var d = { prototype: l }
          i && (d['extends'] = i),
      ...
      E(
        ...
        S(t.prototype, {
          get implementation() {
            ...
            return e
              ? e
              : ((e = new a(C(this).implementation)), H.set(this, e), e)
          },
          get defaultView() {
            return j(C(this).defaultView)
          }
        }),
      ...
      ;(a.prototype.createDocument = function() {
        return (arguments[2] = C(arguments[2])), j(A.apply(N(this), arguments))
      }),
    ...
    (function(e) {
      ...
      var n = e.wrappers.EventTarget,
        ...
        p = window.getDefaultComputedStyle,
        h = window.getSelection
      ;(t.prototype = Object.create(n.prototype)),
        (u.prototype.getComputedStyle = function(e, t) {
          return l(this || window).getComputedStyle(c(e), t)
        }),
        p &&
          (u.prototype.getDefaultComputedStyle = function(e, t) {
    ...
    (function(e) {
      ...
      function r(e) {
        ...
        else console.warn('sheet not found', t)
      ...
      function a(e, t) {
        if (t) {
          ...
          if (e.match('@import') && D) {
            var a = n(e)
            i(function(e) {
              e.head.appendChild(a.impl),
                (o = Array.prototype.slice.call(a.sheet.cssRules, 0)),
                t(o)
            })
          } else (o = r(e)), t(o)
        }
      ...
      var u = {
          ...
          shimStyling: function(e, n, r) {
            var o = this.prepareRoot(e, n, r),
              i = this.isTypeExtension(r),
              a = this.makeScopeSelector(n, i),
              s = t(o, !0)
            ;(s = this.scopeCssText(s, a)),
              e && (e.shimmedStyle = s),
              this.addCssToDocument(s, n)
          },
          ...
          prepareRoot: function(e, t, n) {
            ...
            return (
              this.replaceTextInStyles(r.rootStyles, this.insertDirectives),
              this.removeStyles(e, r.rootStyles),
              this.strictStyling && this.applyScopeToContent(e, t),
              r.scopeStyles
            )
          },
          removeStyles: function(e, t) {
            for (var n, r = 0, o = t.length; r < o && (n = t[r]); r++)
              n.parentNode.removeChild(n)
          },
          registerRoot: function(e, t, n) {
            var r = (this.registry[t] = { root: e, name: t, extendsName: n }),
              o = this.findStyles(e)
          ...
          applyScopeToContent: function(e, t) {
            e &&
              (Array.prototype.forEach.call(e.querySelectorAll('*'), function(
                e
              ) {
                e.setAttribute(t, '')
              }),
          ...
          insertDirectives: function(e) {
            return (
              (e = this.insertPolyfillDirectivesInCssText(e)),
              this.insertPolyfillRulesInCssText(e)
            )
          },
          insertPolyfillDirectivesInCssText: function(e) {
            return (
              (e = e.replace(p, function(e, t) {
                return t.slice(0, -2) + '{'
              })),
          ...
          scopeCssText: function(e, t) {
            ...
            if (
              ((e = this.insertPolyfillHostInCssText(e)),
              (e = this.convertColonHost(e)),
              (e = this.convertColonHostContext(e)),
              (e = this.convertShadowDOMSelectors(e)),
              t)
            ) {
              var e,
                r = this
          ...
          convertColonRule: function(e, t, n) {
            return e.replace(t, function(e, t, r, o) {
              if (((t = O), r)) {
                for (
                  var i, a = r.split(','), s = [], c = 0, l = a.length;
                  c < l && (i = a[c]);
                  c++
                )
          ...
          colonHostContextPartReplacer: function(e, t, n) {
            return t.match(g)
              ? this.colonHostPartReplacer(e, t, n)
              : e + t + n + ', ' + t + ' ' + e + n
          },
                  ...
                  function(e) {
                    if (e.selectorText && e.style && void 0 !== e.style.cssText)
                      ...
                      (n += '@media ' + e.media.mediaText + ' {\n'),
                        (n += this.scopeRules(e.cssRules, t)),
                        (n += '\n}\n\n')
                    else
                      try {
                        e.cssText && (n += e.cssText + '\n\n')
                      } catch (r) {
                        e.type === CSSRule.KEYFRAMES_RULE &&
                          e.cssRules &&
                          (n += this.ieSafeCssTextFromKeyFrameRule(e))
                      }
                  },
                  this
                ),
          ...
          ieSafeCssTextFromKeyFrameRule: function(e) {
            ...
            return (
              Array.prototype.forEach.call(e.cssRules, function(e) {
          ...
          scopeSelector: function(e, t, n) {
            ...
            return (
              o.forEach(function(e) {
                ;(e = e.trim()),
                  this.selectorNeedsScoping(e, t) &&
                    (e =
                      n && !e.match(O)
                        ? this.applyStrictSelectorScope(e, t)
                        : this.applySelectorScope(e, t)),
                  r.push(e)
              }, this),
              r.join(', ')
            )
          ...
          applySelectorScope: function(e, t) {
            return Array.isArray(t)
              ? this.applySelectorScopeList(e, t)
              : this.applySimpleSelectorScope(e, t)
          },
          applySelectorScopeList: function(e, t) {
            for (var n, r = [], o = 0; (n = t[o]); o++)
              r.push(this.applySimpleSelectorScope(e, n))
            return r.join(', ')
          },
          applySimpleSelectorScope: function(e, t) {
            return e.match(L)
              ? ((e = e.replace(O, t)), e.replace(L, t + ' '))
              : t + ' ' + e
          },
          ...
          insertPolyfillHostInCssText: function(e) {
            return e.replace(M, b).replace(T, g)
          },
          propertiesFromRule: function(e) {
            var t = e.style.cssText
            e.style.content &&
              !e.style.content.match(/['"]+|attr/) &&
              (t = t.replace(
                /content:[^;]*;/g,
        ...
        d = /\/\*[^*]*\*+([^\/*][^*]*\*+)*\//gim,
        p = /\/\*\s*@polyfill ([^*]*\*+([^\/*][^*]*\*+)*\/)([^{]*?){/gim,
        h = /polyfill-next-selector[^}]*content\:[\s]*?['"](.*?)['"][;\s]*}([^{]*?){/gim,
        f = /\/\*\s@polyfill-rule([^*]*\*+([^\/*][^*]*\*+)*)\//gim,
        m = /(polyfill-rule)[^}]*(content\:[\s]*['"](.*?)['"])[;\s]*[^}]*}/gim,
        w = /\/\*\s@polyfill-unscoped-rule([^*]*\*+([^\/*][^*]*\*+)*)\//gim,
        v = /(polyfill-unscoped-rule)[^}]*(content\:[\s]*['"](.*?)['"])[;\s]*[^}]*}/gim,
        g = '-shadowcsshost',
        b = '-shadowcsscontext',
        y = ')(?:\\(((?:\\([^)(]*\\)|[^)(]*)+?)\\))?([^,{]*)',
        E = new RegExp('(' + g + y, 'gim'),
        _ = new RegExp('(' + b + y, 'gim'),
        S = '([>\\s~+[.,{:][\\s\\S]*)?$',
        T = /\:host/gim,
        M = /\:host-context/gim,
        O = g + '-no-combinator',
      ...
      var j,
        D = navigator.userAgent.match('Chrome'),
        H = 'shim-shadowdom',
        x = 'shim-shadowdom-css',
        R = 'no-shim'
      if (window.ShadowDOMPolyfill) {
        s('style { display: none !important; }\n')
        var I = ShadowDOMPolyfill.wrap(document),
          P = I.querySelector('head')
        P.insertBefore(l(), P.childNodes[0]),
          document.addEventListener('DOMContentLoaded', function() {
            e.urlResolver
            if (window.HTMLImports && !HTMLImports.useNative) {
              var t = 'link[rel=stylesheet][' + H + ']',
                n = 'style[' + H + ']'
              ;(HTMLImports.importer.documentPreloadSelectors += ',' + t),
                (HTMLImports.importer.importsPreloadSelectors += ',' + t),
              ...
              HTMLImports.parser.parseGeneric = function(e) {
                if (!e[x]) {
                  ...
                  e.__resource &&
                    ((t = e.ownerDocument.createElement('style')),
                    (t.textContent = e.__resource)),
                    HTMLImports.path.resolveUrlsInStyle(t, e.href),
                    (t.textContent = u.shimStyle(t)),
                    t.removeAttribute(H, ''),
                    t.setAttribute(x, ''),
                    (t[x] = !0),
                    t.parentNode !== P &&
    ...
    function a(e, a, s) {
      ...
      e: for (; (e[u - 1] != f || 0 == u) && !this._isInvalid; ) {
        ...
        switch (l) {
          ...
          case 'file host':
            if (f == y || '/' == y || '\\' == y || '?' == y || '#' == y) {
              2 != d.length || !m.test(d[0]) || (':' != d[1] && '|' != d[1])
                ? 0 == d.length
                  ? (l = 'relative path start')
                  : ((this._host = r.call(this, d)),
                    (d = ''),
                    (l = 'relative path start'))
                : (l = 'relative path')
              continue
    ...
    if (!l) {
      ...
      c.prototype = {
        ...
        set pathname(e) {
          !this._isInvalid &&
            this._isRelative &&
            ((this._path = []), a.call(this, e, 'relative path start'))
        },
        get search() {
  ...
  (function(e) {
    ...
    function u(e) {
      return S ? S : ((S = c(_)), (S.oldValue = e), S)
    }
    function d() {
      _ = S = void 0
    }
    ...
    if (!e.JsMutationObserver) {
      ...
      a.prototype = {
        observe: function(e, t) {
          ...
          o || ((o = new f(this, e, t)), r.push(o), this.nodes_.push(e)),
            o.addListeners()
        },
        disconnect: function() {
          this.nodes_.forEach(function(e) {
          ...
          switch ((e.stopImmediatePropagation(), e.type)) {
            ...
            case 'DOMNodeInserted':
              ...
              var h = p.previousSibling,
                f = p.nextSibling,
                o = l('childList', e.target.parentNode)
              ;(o.addedNodes = s),
                (o.removedNodes = c),
                (o.previousSibling = h),
                (o.nextSibling = f),
  ...
  (function(e) {
    ...
    function r(e, t) {
      if (n(t)) e && e()
        ...
        var o = function() {
          ;('complete' !== t.readyState && t.readyState !== v) ||
            (t.removeEventListener(g, o), r(e, t))
        }
    ...
    function i(e, t) {
      function n() {
        c == l && e && e({ allImports: s, loadedImports: u, errorImports: d })
      }
      function r(e) {
        o(e), u.push(this), c++, n()
      }
      ...
      var s = t.querySelectorAll('link[rel=import]'),
        ...
        d = []
      if (l)
        for (var p, h = 0; h < l && (p = s[h]); h++)
          a(p)
            ? (u.push(this), c++, n())
            : (p.addEventListener('load', r), p.addEventListener('error', i))
      else n()
    }
    function a(e) {
      return d
    ...
    function s(e) {
      for (var t, n = 0, r = e.length; n < r && (t = e[n]); n++) c(t) && l(t)
    }
    function c(e) {
    ...
    var u = 'import',
      d = Boolean(u in document.createElement('link')),
      p = Boolean(window.ShadowDOMPolyfill),
      h = function(e) {
        return p ? window.ShadowDOMPolyfill.wrapIfNeeded(e) : e
      },
      f = h(document),
      m = {
        get: function() {
  ...
  window.HTMLImports.addModule(function(e) {
    ...
    ;(r.prototype = {
      ...
      receive: function(e, t, n, r, o) {
        this.cache[e] = r
        for (
          var i, a = this.pending[e], s = 0, c = a.length;
          s < c && (i = a[s]);
          s++
        )
    ...
    var a = e.path,
      ...
      p = {
        ...
        parse: function(e) {
          if (this.isParsed(e))
            return void (
              c.parse && console.log('[%s] is already parsed', e.localName)
            )
        ...
        trackElement: function(e, t) {
          ...
          if (
            ...
            if (e.textContent.indexOf('@import') == -1) o = !0
              ...
              o = !0
              for (
                var i, a = e.sheet.cssRules, s = a ? a.length : 0, c = 0;
                c < s && (i = a[c]);
                c++
              )
    ...
    var i = e.flags,
      ...
      p = {
        ...
        bootDocument: function(e) {
          this.loadSubtree(e), this.observer.observe(e), d.parseNext()
        },
        loadedAll: function() {
          d.parseNext()
        }
      },
      h = new l(p.loaded.bind(p), p.loadedAll.bind(p))
    if (((p.observer = new u()), !document.baseURI)) {
      var f = {
        get: function() {
      ...
      Object.defineProperty(document, 'baseURI', f),
        Object.defineProperty(c, 'baseURI', f)
    }
    ;(e.importer = p), (e.importLoader = h)
  }),
  window.HTMLImports.addModule(function(e) {
    var t = e.parser,
      n = e.importer,
      r = {
        added: function(e) {
          for (var r, o, i, a, s = 0, c = e.length; s < c && (a = e[s]); s++)
  ...
  window.CustomElements.addModule(function(e) {
    ...
    function o(e) {
      S.push(e), _ || ((_ = !0), setTimeout(i))
    }
    function i() {
      _ = !1
      for (var e, t = S, n = 0, r = t.length; n < r && (e = t[n]); n++) e()
      S = []
    }
    function a(e) {
      E
    ...
    var g = e.flags,
      b = e.forSubtree,
      y = e.forDocumentTree,
      E = window.MutationObserver._isPolyfilled && g['throttle-attached']
    ;(e.hasPolyfillMutations = E), (e.hasThrottledAttached = E)
    var _ = !1,
      S = [],
  ...
  window.CustomElements.addModule(function(e) {
    ...
    function r(e, t) {
      Object.__proto__
        ...
        : (o(e, t.prototype, t['native']), (e.__proto__ = t.prototype))
    }
    function o(e, t, n) {
  ...
  window.CustomElements.addModule(function(e) {
    ...
    function h(e, t) {
      ...
      var r
      return t
        ? ((r = h(e)), r.setAttribute('is', t), r)
        : ((r = T(e)), e.indexOf('-') >= 0 && b(r, HTMLElement), r)
    }
    function f(e, t) {
      var n = e[t]
      e[t] = function() {
    ...
    var m,
      w = (e.isIE, e.upgradeDocumentTree),
      v = e.upgradeAll,
